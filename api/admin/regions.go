...
type AddRegionsReq struct {
	g.Meta `path:"/regions" tags:"后台/地区" summary:"增加地区"`
...
type UpdateRegionsReq struct {
	g.Meta `path:"/regions" tags:"后台/地区" summary:"修改地区"`
...
type DeleteRegionsReq struct {
	g.Meta `path:"/regions" tags:"后台/地区" summary:"删除地区"`

	ID int `json:"id" v:"required#ID不能为空"`
}

type GetRegionsReq struct {
	g.Meta `path:"/regions" tags:"后台/地区" summary:"获取地区"`

	ID int `json:"id" v:"required#ID不能为空"`
}

type GetRegionsListReq struct {
	g.Meta `path:"/regions/list" tags:"后台/地区" summary:"获取地区列表"`
}
